...
|---|---|---|
| ADR-001 | 00_arquitetura | RESULTADO_TIPO_OPERACAO e tipo_resultado_operacao() de CONTRACTS.py |
| ADR-004 | 00_arquitetura | int+real é erro semântico mesmo que assembly use F64 para ambos |
